...
static int sq_do_work(struct io_ring_ctx *ctx_ptr, struct mm_struct *cur_mm, struct sqe_submit (*sqes)[IO_IOPOLL_BATCH])
{
		...
		inflight += io_submit_sqes(ctx_ptr, sqes[0], i, cur_mm != NULL,
						mm_fault);
